...
- Thursday (Mar 2), 2--3:30 p.m.

Holden Lee has `scribed notes <http://simons-institute.github.io/pseudorandomness/pdfs/modelnotes-by-holdenlee.pdf>`_ from Russell Impagliazzo's lectures.
His source files are `here <https://github.com/holdenlee/simons-ml/tree/master/reading_groups/models/edited>`_.
